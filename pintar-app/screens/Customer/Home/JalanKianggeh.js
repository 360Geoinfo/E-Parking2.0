...
export const JalanKianggehPolygon = ({ onParkingPress }) => {
  const center1 = { latitude: 4.887637, longitude: 114.944450
 };

  const rawCoords2 = [
    { latitude: center1.latitude + 0.00010, longitude: center1.longitude - 0.0003 },
    { latitude: center1.latitude + 0.00010, longitude: center1.longitude + 0.0003 },
    { latitude: center1.latitude - 0.00002, longitude: center1.longitude + 0.0003 },
    { latitude: center1.latitude - 0.00002, longitude: center1.longitude - 0.0003 },
  ];

   const coords1 = rawCoords2.map((coord) =>
    rotateCoordinate(coord, center1, 80)
  );
  ...
  return (
    <>
      <Polygon
        ...
        tappable
      />
      <Marker coordinate={center1} onPress={() => onParkingPress('Sepanjang Jalan Kianggeh')}>
