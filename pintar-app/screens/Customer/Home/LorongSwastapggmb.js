...
export const LorongSwastapggmbPolygon = ({ onParkingPress }) => {
  const center1 = { latitude: 4.889880, longitude: 114.943768
 };
  ...
  return (
    <>
      <Polygon
        ...
        tappable
      />
      <Marker coordinate={center1} onPress={() => onParkingPress('Lorong Swasta PGGMB')}>
