...
export const JalanKianggehLapauAtasPolygon = ({ onParkingPress }) => {
  const center1 = { latitude: 4.891826, longitude: 114.943493
 };

  const rawCoords2 = [
    { latitude: center1.latitude + 0.00010, longitude: center1.longitude - 0.0005 },
    { latitude: center1.latitude + 0.00010, longitude: center1.longitude + 0.0005 },
    { latitude: center1.latitude - 0.00002, longitude: center1.longitude + 0.0005 },
    { latitude: center1.latitude - 0.00002, longitude: center1.longitude - 0.0005 },
  ];
  ...
  return (
    <>
      <Polygon
        ...
        tappable
      />
      <Marker coordinate={center1} onPress={() => onParkingPress('Jalan Kianggeh Lapau Atas')}>
