...
export const JalanPanggungPolygon = ({ onParkingPress }) => {
  const center1 = { latitude: 4.887865, longitude: 114.944138
 };
  ...
  return (
    <>
      <Polygon
        ...
        tappable
      />
      <Marker coordinate={center1} onPress={() => onParkingPress('Jalan Panggung Bolkiah')}>
